...
function SubContent() {
	...
	return (
		<>
			{!loaded && 
				<div role="status" className="skeleton animate-pulse py-20 px-2 xl:px-80 xl:flex justify-center items-center gap-8">
			...
			<section id="subcontent" className="content py-20 px-2 xl:px-20 wide:px-80 xl:flex items-center gap-8">
				...
				<img ref={image} src={trancioPizza} className="w-full xl:w-2/4" width="50%" style={{ display: loaded ? 'block' : 'none' }} />
			</section>
