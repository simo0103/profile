...
function SubContent() {
    ...
    const text =
        'The pizza served in Santa Maria is exactly the same as the pizza you can eat on the streets of Naples using the same ingredients and adopting the same cooking method'.split(
            ' '
        );
    useEffect(() => {
        ...
        if (imageCurrent) {
            ...
            return () =>
                imageCurrent.removeEventListener('load', onImageLoaded);
        }
    }, [image]);
    return (
        <>
