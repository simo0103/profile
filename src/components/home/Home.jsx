        ...
        <div id="home" className="bg-black">
            ...
            >
                {!loaded && (
                    <div
                        role="status"
                        className="skeleton  bg-gray-600 dark:bg-gray-800 animate-pulse w-full aspect-[3/4] xl:aspect-video"
                    ></div>
                )}
                ...
                {loaded && (
                    <div className="absolute w-full text-center top-[20%] xl:translate-x-[-50%] xl:top-[20%] xl:left-1/2 z-10">
                        <h2 className="text-white uppercase font-steelfishBold text-xxl xl:text-[80px] wide:text-[100px] mb-8">
                            real napoletan{' '}
                            <span className="text-[46px] xl:text-[78px] wide:text-[96px] uppercase font-steelfishOut">
                                pizza
                            </span>
                        </h2>
            ...
            <section>
                <ul className="flex gap-6 justify-center text-center w-3/4 mx-auto my-5 xl:my-20">
                    ...
                    <li className="w-[100px]">
                        ...
                        <p className="text-white mb-4 font-latoBlack">
                            Delivery
                        </p>
                    </li>
                </ul>
